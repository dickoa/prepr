...
After installing these two libraries, you can now install the development version of `prepair` R package from [Gitlab](https://gitlab.com/dickoa/prepair) using the `remotes` R package with:
